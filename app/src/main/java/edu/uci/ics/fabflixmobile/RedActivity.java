...
public class RedActivity extends ActionBarActivity {
    ...
    public void connectToTomcat(View view) {
        ...
        final StringRequest loginRequest = new StringRequest(Request.Method.POST, "http://10.0.2.2:8080/2019w-project4-login-example/api/login",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
    ...
    public void goToBlue(View view) {
        ...
        Intent goToIntent = new Intent(RedActivity.this, RedActivity.class);
